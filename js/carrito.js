...
//     var items =document.getElementsByClassName('contenedor-producto')[0];
//     items.style.width = '98%';
...
//         var precio = parseFloat(precioElemento.innerText.replace('S/','').replace('.',''));                           /*  reemplaza el símbolo 'S/' con una cadena vacía, eliminándolo del texto. */
...
// // make a function that give an alert when you click on the button "pagar"
// function pagarprueba (){
//     alert("Gracias por su compra");
// }

function pagarprueba(){
    var botonPagar = document.querySelector('.pagar');
...
// Seleccionamos el botón de pagar
